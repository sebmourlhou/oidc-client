...
sub test_has_expired_without_configured_leeway {

  subtest "has_expired() without configured leeway" => sub {
    ...
    {
      # When
      my $has_expired = $client->has_expired(time - 1);
    ...
    {
      # When
      my $has_expired = $client->has_expired(time + 2);
...
sub test_has_expired_with_configured_leeway {

  subtest "has_expired() with configured leeway" => sub {
    ...
    {
      # When
      my $has_expired = $client->has_expired(time + 18);

      # Then
      ok($has_expired,
         'has expired due to the leeway');
    }

    {
      # When
      my $has_expired = $client->has_expired(time + 22);
